...
\section{Experiencia}
\cventry{2023}{Programmer Trainne}{Heinz Glas}{Lima}{Perú}{Desarrollé una aplicación en C\# .NET ASP.NET para la automatización de procesos de la planta de producción.}
