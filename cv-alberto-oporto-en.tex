...
\cventry{05/2023 - Present}{Software Engineer}{TITANIUS CONSULTING S.R.L.}{Lima}{Perú}{
	\begin{itemize}
		\item Developed RESTful microservices using multiple languages, including Java, C\#, Python and Typescript.
		\item  Streamlined local development by containerizing backend, CSR and SSR frontend services using Docker Bake and Docker Compose.
		\item Designed and implemented Gitlab CI/CD pipelines with Bash to automate the building of Docker images, testing and deployment into a baremetal, Kubernetes cluster.
		\item Automated SSL certificate provisioning and renewal with Caddy and Let's Encrypt.
	\end{itemize}
}
\cventry{02/2023 - 04/2023}{Programmer Trainee}{HEINZ - GLAS PERU S.A.C.}{Lima}{Perú}{
	\begin{itemize}
		\item Developed an internal MVC web application with C\# ASP.NET.
		\item Deployed a self hosted Gitea instance on a legacy Windows Server.
		\item Created Selenium scripts to wrap legacy internal web applications.
	\end{itemize}
...
\cvlistitem{Linux}
\cvlistitem{CI/CD}
\cvlistitem{Docker / Docker Compose / Kubernetes}
\cvlistitem{Git / Github / Gitlab / Gitea}
\cvlistitem{SQL / PostgreSQL}

\section{Projects}
\cventry{}{GPU accelerated simulator}{\httplink{github.com/fdtd-lucuma/fdtd-lucuma}}{}{}
{
	A gpu-accelerated FDTD simulator written in C++ using Vulkan and Dear Imgui.
}
\cventry{}{Game engine}{\httplink{github.com/otreblan/vulkan-hello}}{}{}
{
	A game engine prototype based on Entity Component System made with C++ and Vulkan.
