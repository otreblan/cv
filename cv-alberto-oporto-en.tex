...
\cventry{2023-Present}{Software Engineer}{Titanius Consulting}{Lima}{Perú}{
	I developed the backend of an internal service with C\# ASP.net and wrote Pandas scripts to clean and insert data into the Database. Finally I containerized and automated the deployment (CI) of the project.
}
\cventry{2023}{Programmer Trainee}{Heinz Glas}{Lima}{Perú}{
	I developed an internal WebApp with C\# ASP.NET for production plant automatization. Also I wrote Bash scripts to interface with legacy systems.
