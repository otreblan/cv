...
\cventry{2023-Present}{Software Engineer}{Titanius Consulting}{Lima}{Perú}{
	Developed a backend with C\# ASP.net. Also wrote Pandas scripts to clean and insert data into the Database. Finally I containerized and automated the deployment (CI) of the project.
}
\cventry{2023}{Programmer Trainee}{Heinz Glas}{Lima}{Perú}{
	Developed an internal WebApp with C\# ASP.NET for production plant automatization. Also I wrote Bash scripts to interface with legacy systems.
