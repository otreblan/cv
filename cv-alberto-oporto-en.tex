...
\section{Experience}
% TODO: Potencial
\cventry{2023-}{Software Engineer}{Titanius Consulting}{Lima}{Perú}{
...
\cventry{2023}{Programmer Trainee}{Heinz Glas}{Lima}{Perú}{
	Depeloped an internal WebApp with C\# ASP.NET for production plant automatization. Also I wrote Bash scripts to interface with legacy systems.
