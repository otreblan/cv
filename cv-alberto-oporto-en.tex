...
\cventry{05/2023 - Present}{Software Engineer}{Titanius Consulting}{Lima}{Perú}{
	Developed the backend of an internal service with C\# ASP.net. Then I wrote Pandas scripts to clean and insert data into the Database. Finally I containerized and automated the deployment of the project with Docker Compose and Gitlab CI.
}
\cventry{02/2023 - 04/2023}{Programmer Trainee}{Heinz Glas}{Lima}{Perú}{
	Developed an internal WebApp with C\# ASP.NET for production plant automatization. Also I wrote shell scripts to interface with legacy systems.
