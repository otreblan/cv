...
\cventry{05/2023 - Present}{Software Engineer}{TITANIUS CONSULTING S.R.L.}{Lima}{Perú}{
	\begin{itemize}
		...
		\item  Streamlined local development and CI/CD pipelines by containerizing backend, CSR and SSR frontend services using Docker Bake and Docker Compose.
		\item Designed and implemented Gitlab CI/CD pipelines with Bash to automate the building of Docker images, testing and deployment into a Linux VPS.
...
\cventry{}{IOT UV sensor}{\httplink{github.com/otreblan/esp8266-uv}}{}{}
{
	...
	My team and I utilized an esp8266, a 3d printed case and an uv light sensor to log solar radiation. I coded the firmware with C++ and Espressif RTOS.
}
